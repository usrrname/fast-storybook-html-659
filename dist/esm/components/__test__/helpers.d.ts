...
import { AnnotatedStoryFn, Args, ComponentAnnotations, StoryAnnotations, StoryContext } from "@storybook/csf";
/**
 ...
 */
export declare function renderComponent<TArgs = Args>(template: ViewTemplate): (args: Args, context: StoryContext) => Element | DocumentFragment | null;
/**
 * A helper that returns a function to bind a Storybook story to a ViewTemplate.
 */
